...
export const getCreateInquiryMutationOptions = <TError = ErrorType<ApiErrorMessage>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateInquiryMutationError = ErrorType<ApiErrorMessage>

    /**
 * @summary Submit an inquiry or booking request
 */
export const useCreateInquiry = <TError = ErrorType<ApiErrorMessage>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createInquiry>>, TError,{data: BodyType<InquiryInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
